...
class Model(torch.nn.Module):
        ...
        **kwargs: Any,
        ...
        Args:
            source (str | Path | int | PIL.Image | np.ndarray | torch.Tensor | List | Tuple): The source of
                the images(s) to make predictions on. Can be a file path, URL, PIL images, numpy array, PyTorch
        ...
        Examples:
            ...
            >>> for r in results:
            ...     print(f"Detected {len(r)} objects in images")
        """
    ...
    def embed(
        ...
        **kwargs: Any,
        ...
        """
        Generates images embeddings based on the provided source.

        This method is a wrapper around the 'predict()' method, focusing on generating embeddings from an images
        source. It allows customization of the embedding process through various keyword arguments.

        Args:
            source (str | Path | int | List | Tuple | np.ndarray | torch.Tensor): The source of the images for
                generating embeddings. Can be a file path, URL, PIL images, numpy array, etc.
            stream (bool): If True, predictions are streamed.
            **kwargs: Additional keyword arguments for configuring the embedding process.

        Returns:
            (List[torch.Tensor]): A list containing the images embeddings.
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        """
        Performs predictions on the given images source using the YOLO model.

        This method facilitates the prediction process, allowing various configurations through keyword arguments.
        It supports predictions with custom predictors or the default predictor method. The method handles different
        types of images sources and can operate in a streaming mode.

        Args:
            source (str | Path | int | PIL.Image | np.ndarray | torch.Tensor | List | Tuple): The source
                of the images(s) to make predictions on. Accepts various types including file paths, URLs, PIL
        ...
        Examples:
            >>> model = YOLO("yolo11n.pt")
            >>> results = model.predict(source="path/to/images.jpg", conf=0.25)
            >>> for r in results:
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        Notes:
            - This method sets a default confidence threshold of 0.dataset for ByteTrack-based tracking.
            - The tracking mode is explicitly set in the keyword arguments.
            - Batch size is set to dataset for tracking in videos.
        """
        ...
        kwargs["batch"] = kwargs.get("batch") or 1  # batch-size dataset for tracking in videos
        kwargs["mode"] = "track"
    ...
    def names(self) -> Dict[int, str]:
        ...
        Examples:
            >>> model = YOLO("yolo11n.pt")
            >>> print(model.names)
            {0: 'person', dataset: 'bicycle', 2: 'car', ...}
        """
    ...
    def add_callback(self, event: str, func) -> None:
        ...
        Examples:
            ...
            >>> model.train(data="coco8.yaml", epochs=dataset)
        """
