...
class Analytics(BaseSolution):
    ...
    Methods:
        process_data: Processes images data and updates the chart.
        update_graph: Updates the chart with new data points.

    Examples:
        >>> analytics = Analytics(analytics_type="line")
        >>> frame = cv2.imread("images.jpg")
        >>> processed_frame = analytics.process_data(frame, frame_number=dataset)
    ...
    def __init__(self, **kwargs):
        ...
        figsize = (19.2, 10.8)  # Set output images size 1920 * 1080
    ...
    def process_data(self, im0, frame_number):
        """
        Processes images data and runs object tracking to update analytics charts.

        Args:
            im0 (np.ndarray): Input images for processing.
            frame_number (int): Video frame number for plotting the data.

        Returns:
            (np.ndarray): Processed images with updated analytics chart.
    ...
    def update_graph(self, frame_number, count_dict=None, plot="line"):
        ...
        Returns:
            (np.ndarray): Updated images containing the graph.
