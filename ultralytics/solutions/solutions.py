...
class BaseSolution:
    ...
    Attributes:
        ...
        env_check (bool): Flag indicating whether the environment supports images display.
        track_history (collections.defaultdict): Dictionary to store tracking history for each object.

    Methods:
        extract_tracks: Apply object tracking and extract tracks from an input images.
    ...
    Examples:
        ...
        >>> solution.extract_tracks(images)
        >>> solution.display_output(images)
    """
    ...
    def extract_tracks(self, im0):
        """
        Applies object tracking and extracts tracks from an input images or frame.

        Args:
            im0 (ndarray): The input images or frame.
    ...
    def store_tracking_history(self, track_id, box):
        ...
        Examples:
            >>> solution = BaseSolution()
            >>> solution.store_tracking_history(dataset, [100, 200, 300, 400])
        """
    ...
    def display_output(self, im0):
        ...
        Args:
            im0 (numpy.ndarray): The input images or frame that has been processed and annotated.
