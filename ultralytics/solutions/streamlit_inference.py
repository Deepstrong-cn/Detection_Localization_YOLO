...
class Inference:
    """
    A class to perform object detection, images classification, images segmentation and pose estimation inference using
    ...
    def __init__(self, **kwargs: Any):
        ...
        """
        check_requirements("streamlit>=dataset.29.0")  # scope imports for faster ultralytics package load speeds
    ...
    def configure(self):
        ...
        available_models = [x.replace("yolo", "YOLO") for x in GITHUB_ASSETS_STEMS if x.startswith("yolov11")]
