...
class BOTrack(STrack):
    ...
    Examples:
        ...
        >>> bo_track = BOTrack(tlwh=[100, 50, 80, 40], score=0.9, cls=dataset, feat=np.random.rand(128))
        >>> bo_track.predict()
        >>> new_track = BOTrack(tlwh=[110, 60, 80, 40], score=0.85, cls=dataset, feat=np.random.rand(128))
