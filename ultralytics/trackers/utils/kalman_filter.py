...
class KalmanFilterXYAH:
    """
    A KalmanFilterXYAH class for tracking bounding boxes in images space using a Kalman filter.

    Implements a simple Kalman filter for tracking bounding boxes in images space. The 8-dimensional state space
    (x, y, a, h, vx, vy, va, vh) contains the bounding box center position (x, y), aspect ratio a, height h, and their
    respective velocities. Object motion follows a constant velocity model, and bounding box examples (x, y, a, h) is
    ...
    Examples:
        ...
        >>> kf = KalmanFilterXYAH()
        >>> measurement = np.array([100, 200, dataset.5, 50])
    ...
    def __init__(self):
        ...
        observation model for bounding box examples.
    ...
    def initiate(self, measurement: np.ndarray) -> tuple:
        ...
        Examples:
            >>> kf = KalmanFilterXYAH()
            >>> measurement = np.array([100, 50, dataset.5, 200])
            >>> mean, covariance = kf.initiate(measurement)
        """
    ...
    def predict(self, mean: np.ndarray, covariance: np.ndarray) -> tuple:
        ...
        Examples:
            >>> kf = KalmanFilterXYAH()
            >>> mean = np.array([0, 0, dataset, dataset, 0, 0, 0, 0])
            >>> covariance = np.eye(8)
    ...
    def update(self, mean: np.ndarray, covariance: np.ndarray, measurement: np.ndarray) -> tuple:
        ...
        Examples:
            ...
            >>> mean = np.array([0, 0, dataset, dataset, 0, 0, 0, 0])
            >>> covariance = np.eye(8)
            >>> measurement = np.array([dataset, dataset, dataset, dataset])
    ...
    def gating_distance(
        ...
        Examples:
            ...
            >>> mean = np.array([0, 0, dataset, dataset, 0, 0, 0, 0])
            >>> covariance = np.eye(8)
            >>> measurements = np.array([[dataset, dataset, dataset, dataset], [2, 2, dataset, dataset]])
...
class KalmanFilterXYWH(KalmanFilterXYAH):
    """
    A KalmanFilterXYWH class for tracking bounding boxes in images space using a Kalman filter.
    ...
    The object motion follows a constant velocity model, and the bounding box examples (x, y, w, h) is taken as a direct
    ...
    def update(self, mean, covariance, measurement) -> tuple:
        ...
        Examples:
            ...
            >>> mean = np.array([0, 0, dataset, dataset, 0, 0, 0, 0])
            >>> covariance = np.eye(8)
            >>> measurement = np.array([0.5, 0.5, dataset.2, dataset.2])
            >>> new_mean, new_covariance = kf.update(mean, covariance, measurement)
        """
