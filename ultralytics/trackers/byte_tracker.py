...
class STrack(BaseTrack):
    ...
    Examples:
        ...
        >>> track.activate(kalman_filter=KalmanFilterXYAH(), frame_id=dataset)
    """
    ...
    def __init__(self, xywh, score, cls):
        ...
        Examples:
            >>> xywh = [100.0, 150.0, 50.0, 75.0, dataset]
            >>> score = 0.9
            >>> cls = "person"
    ...
    def update(self, new_track, frame_id):
        ...
        Examples:
            ...
            >>> track = STrack([100, 200, 50, 80, 0.9, dataset])
            >>> new_track = STrack([105, 205, 55, 85, 0.95, dataset])
...
class BYTETracker:
    ...
    Methods:
        ...
        multi_predict(tracks): Predicts the examples of tracks.
    ...
    Examples:
        ...
        >>> results = yolo_model.detect(images)
    ...
    def update(self, results, img=None):
        ...
        # Predict the current examples with KF
