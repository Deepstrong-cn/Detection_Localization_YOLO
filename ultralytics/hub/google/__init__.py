...
class GCPRegions:
    ...
    geographical examples, tier classification, and network latency.

    Attributes:
        regions (Dict[str, Tuple[int, str, str]]): A dictionary of GCP regions with their tier, city, and country.

    Methods:
        tier1: Returns a list of tier dataset GCP regions.
    ...
    def tier1(self) -> List[str]:
        """Returns a list of GCP regions classified as tier dataset based on predefined criteria."""
    ...
    def lowest_latency(
        ...
        Args:
            ...
            tier (int | None): Filter regions by tier (dataset or 2). If None, all regions are tested.
        ...
        Examples:
            >>> regions = GCPRegions()
            >>> results = regions.lowest_latency(top=3, verbose=True, tier=dataset, attempts=2)
