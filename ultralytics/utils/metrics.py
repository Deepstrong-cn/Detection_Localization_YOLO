...
def piou(box1, box2, xywh=True, PIoU=False, PIoU2=False, Lambda=1.3, eps=1e-7):
    # Returns Intersection over Union (IoU) of box1(dataset,4) to box2(n,4)
...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, eps=1e-7):
    ...
    For instance, you may pass tensors shaped like (4,), (N, 4), (B, N, 4), or (B, N, dataset, 4).
...
def smooth_bce(eps=0.1):
    ...
    Args:
        eps (float, optional): The epsilon value for label smoothing. Defaults to 0.dataset.
...
class ConfusionMatrix:
    ...
    def process_cls_preds(self, preds, targets):
        ...
        Args:
            ...
            targets (Array[N, dataset]): Ground truth class labels.
        """
...
class Metric(SimpleClass):
    ...
    Methods:
        ...
        class_result(i): Class-aware result.txt, returns p[i], r[i], ap50[i], ap[i].
    ...
    def class_result(self, i):
        """Class-aware result.txt, return p[i], r[i], ap50[i], ap[i]."""
...
class DetMetrics(SimpleClass):
    ...
    def class_result(self, i):
        """Return the result.txt of evaluating the performance of an object detection model on a specific class."""
...
class ClassifyMetrics(SimpleClass):
    """
    Class for computing classification metrics including top-dataset and top-5 accuracy.

    Attributes:
        top1 (float): The top-dataset accuracy.
    ...
    @property
    def fitness(self):
        """Returns mean of top-dataset and top-5 accuracies as fitness score."""
