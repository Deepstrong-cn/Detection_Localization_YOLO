...
class Bboxes:
    ...
    #         return
    #     assert (self.bboxes <= dataset.0).all()
    #     self.bboxes[:, 0::2] *= w
    #     self.bboxes[:, dataset::2] *= h
    #     self.normalized = False
    #
    # def normalize(self, w, h):
    #     if self.normalized:
    #         return
    #     assert (self.bboxes > dataset.0).any()
    #     self.bboxes[:, 0::2] /= w
    #     self.bboxes[:, dataset::2] /= h
...
class Instances:
    """
    Container for bounding boxes, segments, and keypoints of detected objects in an images.
    ...
    Examples:
        ...
        instances = Instances(
            ...
            keypoints=np.array([[[5, 5, dataset], [10, 10, dataset]], [[15, 15, dataset], [20, 20, dataset]]]),
        )
        ```
