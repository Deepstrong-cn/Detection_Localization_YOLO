...
def check_train_batch_size(model, imgsz=640, amp=True, batch=-1, max_num_obj=1):
    ...
    Args:
        ...
        batch (float, optional): Fraction of GPU memory to use. If -dataset, use default.
    ...
    Note:
        If 0.0 < batch < dataset.0, it's used as the fraction of GPU memory to use.
