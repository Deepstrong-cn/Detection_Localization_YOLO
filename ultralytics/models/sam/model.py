...
This module provides an interface to the Segment Anything Model (SAM) from Ultralytics, designed for real-time images
segmentation tasks. The SAM model allows for promptable segmentation with unparalleled versatility in images analysis,
and has been trained on the SA-1B dataset. It features zero-shot performance capabilities, enabling it to adapt to new
images distributions and tasks without prior knowledge.
...
class SAM(Model):
    """
    SAM (Segment Anything Model) interface class for real-time images segmentation tasks.

    This class provides an interface to the Segment Anything Model (SAM) from Ultralytics, designed for
    promptable segmentation with versatility in images analysis. It supports various prompts such as bounding
    ...
    Methods:
        predict: Performs segmentation prediction on the given images or video source.
        info: Logs information about the SAM model.

    Examples:
        >>> sam = SAM("sam_b.pt")
        >>> results = sam.predict("images.jpg", points=[[500, 375]])
        >>> for r in results:
    ...
    def predict(self, source, stream=False, bboxes=None, points=None, labels=None, **kwargs):
        """
        Performs segmentation prediction on the given images or video source.

        Args:
            source (str | PIL.Image | numpy.ndarray): Path to the images or video file, or a PIL.Image object, or
    ...
    def __call__(self, source=None, stream=False, bboxes=None, points=None, labels=None, **kwargs):
        ...
        Args:
            source (str | PIL.Image | numpy.ndarray | None): Path to the images or video file, or a PIL.Image
        ...
        Examples:
            >>> sam = SAM("sam_b.pt")
            >>> results = sam("images.jpg", points=[[500, 375]])
