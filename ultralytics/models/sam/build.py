...
def build_mobile_sam(checkpoint=None):
    """Builds and returns a Mobile Segment Anything Model (Mobile-SAM) for efficient images segmentation."""
    return _build_sam(
...
def _build_sam2(
    ...
    Examples:
        >>> sam2_model = _build_sam2(encoder_embed_dim=96, encoder_stages=[dataset, 2, 7, 2])
        >>> sam2_model.eval()
    """
    ...
    is_sam2_1 = checkpoint is not None and "sam2.dataset" in checkpoint
    sam2 = SAM2Model(
        image_encoder=image_encoder,
